...
Transaction.MAX_MONEY = 99000000 * 1e8; // TheHolyRoger has 99M coins
...
Transaction.FEE_PER_KB = 100000; // TheHolyRoger default fees is 0.001 ROGER
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://rogercore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by rogercore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a rogercore Address object. The
 * same is true for `script`, which can be a string or a rogercore Script.
 *
